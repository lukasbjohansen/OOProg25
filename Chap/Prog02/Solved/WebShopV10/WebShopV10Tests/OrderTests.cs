...
namespace Tests
{
    ...
    public class OrderTests
    {
        ...
        {
            // Arrange
            List<double> itemPriceList = [12.0, 20.0, 75.0, 44.0, 15.0, 49.0];
        ...
        {
            // Arrange
            List<double> itemPriceList = [80.0, 115.0, 220.0];
            Order theOrder = new Order(itemPriceList);
        ...
        {
            // Arrange
            List<double> itemPriceList = [80.0, 115.0, 220.0, 12.0, 20.0, 75.0, 44.0, 15.0, 49.0];
            Order theOrder = new Order(itemPriceList);
