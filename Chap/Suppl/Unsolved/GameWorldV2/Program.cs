...
// TODO - dette skal tilpasses, så vi kan bruge OpponentFactoryExtended
// i stedet for OpponentFactoryStandard. Det kan f.eks. være ved at tilføje
// en parameter af typen IOpponentFactory til ExecuteScenario.
void ExecuteScenario(Fighter fighter, DayState dayState)
{
	theWorld.DayOrNight = dayState;
	theWorld.TheFighter = fighter;
	theWorld.GenerateEncounter(new OpponentFactoryStandard());
}
