...
public class Test
{
	public void Kør()
	{
		...
		//Console.WriteLine();
		//Console.WriteLine($"Kan vi lave Lagkage : {BoolToJaNej(OpskriftLogik.KanDenLaves(repo, mitLager, lagkage))}");
		//Console.WriteLine($"Kan vi lave Sandkage : {BoolToJaNej(OpskriftLogik.KanDenLaves(repo, mitLager, sandkage))}");
		//Console.WriteLine();
	}
