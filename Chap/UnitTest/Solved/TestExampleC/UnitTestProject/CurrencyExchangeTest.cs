namespace UnitTestProject
{
    ...
    public class CurrencyExchangeTest
    {
        ...
        public void TestSetExchangeRate_InsertSingleIllegal_TooShort_Exception()
        {
            ...
            // Act & Assert
            Assert.ThrowsExactly<ArgumentException>(() => { _currencyExchange.SetExchangeRate("USDDK", 6.50); });
        }
        ...
        public void TestSetExchangeRate_InsertSingleIllegal_TooLong_Exception()
        {
            ...
            // Act & Assert
            Assert.ThrowsExactly<ArgumentException>(() => { _currencyExchange.SetExchangeRate("USDKroner", 6.50); });
        }
        ...
        public void TestSetExchangeRate_InsertSingleIllegal_SameCurrency_Exception()
        {
            ...
            // Act & Assert
            Assert.ThrowsExactly<ArgumentException>(() => { _currencyExchange.SetExchangeRate("USDUSD", 6.50); });
        }
        ...
        public void TestSetExchangeRate_InsertSingleIllegal_Empty_Exception()
        {
            ...
            // Act & Assert
            Assert.ThrowsExactly<ArgumentException>(() => { _currencyExchange.SetExchangeRate("      ", 6.50); });
        }
        ...
        public void TestSetExchangeRate_InsertSingleIllegal_Null_Exception()
        {
            ...
            // Act & Assert
            Assert.ThrowsExactly<ArgumentException>(() => { _currencyExchange.SetExchangeRate(null, 6.50); });
        }
        ...
        public void TestSetExchangeRate_InsertSingleIllegal_NegativeExchangeRate_Exception()
        {
            ...
            // Act & Assert
            Assert.ThrowsExactly<ArgumentException>(() => { _currencyExchange.SetExchangeRate("USDDKK", -6.50); });
        }
        ...
        public void TestSetExchangeRate_InsertSingleIllegal_ZeroExchangeRate_Exception()
        {
            ...
            // Act & Assert
            Assert.ThrowsExactly<ArgumentException>(() => { _currencyExchange.SetExchangeRate("USDDKK", 0.0); });
        }
        ...
        public void TestSetExchangeRate_InsertMultipleWithIllegal_Exception()
        {
            ...
            // Act & Assert
            _currencyExchange.SetExchangeRate("USDDKK", 6.50);
            Assert.ThrowsExactly<ArgumentException>(() => { _currencyExchange.SetExchangeRate("EUDDK", 7.50); });
            _currencyExchange.SetExchangeRate("USDGBP", 0.80);
        }
        ...
        public void TestDoExchange_NonExisting_Exception()
        {
            ...
            // Act & Assert
            Assert.ThrowsExactly<ArgumentException>(() => { double actualResult = _currencyExchange.DoExchange("USDNOR", 200.0); });
        }
        ...
        public void TestDoExchange_Illegal_Exception()
        {
            ...
            // Act & Assert
            Assert.ThrowsExactly<ArgumentException>(() => { double actualResult = _currencyExchange.DoExchange("USDNK", 200.0); });
        }
        ...
        public void TestDoExchange_Illegal_NegativeAmount_Exception()
        {
            ...
            // Act & Assert
            Assert.ThrowsExactly<ArgumentException>(() => { double actualResult = _currencyExchange.DoExchange("USDDKK", -200); });
        }
        ...
        public void TestDoExchange_Illegal_ZeroAmount_Exception()
        {
            ...
            // Act & Assert
            Assert.ThrowsExactly<ArgumentException>(() => { double actualResult = _currencyExchange.DoExchange("USDDKK", 0); });
        }
    }
}