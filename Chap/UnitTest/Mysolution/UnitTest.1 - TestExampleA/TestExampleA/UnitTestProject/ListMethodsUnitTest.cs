namespace UnitTestProject
{
    ...
    public class ListMethodsUnitTest
    {
        ...
        public void TestSumOfSquaresOfPositives_ListIsNull_Exception()
        {
            ...
            // Act & Assert
            Assert.ThrowsExactly<ArgumentException>(() => { testSubject.SumOfSquaresOfPositives(numbers); });
        }
		...
		[TestMethod]
		public void TestSumOfSquaresOfPositives_ListOfVeryHighNumbers()
		{
			// Arrange
			List<int> numbers = new List<int> { -4, 383749878, 92095, -8, 1333, 14879, -21 };
			int expectedResult = 455;
