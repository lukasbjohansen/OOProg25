...
public partial class User : IHarId
{
	public bool IsAdmin() { return Rolle == "admin"; }

	public static User Construct(string navn, string rolle, string passWord)
	{
		return new User { Navn = navn, Rolle = rolle, Password = passWord };
	}
}